  ...
  res.json({
    ...
    endpoints: {
      developer: {
        ...
        login: {
          method: 'POST',
          url: '/api/v1/developer/login',
          description: 'Logs in a developer'
        },
        regenerateEmailVerificationToken: {
          method: 'POST',
          url: '/api/v1/developer/regenerate-email-verification-token',
          description: 'Regenerates the email verification token for a developer'
        }
      },
      organization: {
        create: {
