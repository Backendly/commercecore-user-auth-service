...
urlpatterns = [
    ...
    path('organizations/<int:org_id>/update/', update_organization_view, name='update_organization'),
    path('organizations/<int:org_id>/delete/', delete_organization_view, name='delete_organization'),
    path('organizations/all/', get_all_organizations_view, name='get_all_organizations'),
    path('organizations/<int:org_id>/', get_organization_by_id_view, name='get_organization_by_id'),

    # Developer URLs
    path('developers/create/', create_developer_view, name='create_developer'),
    path('developers/<int:dev_id>/update/', update_developer_view, name='update_developer'),
    path('developers/<int:dev_id>/delete/', delete_developer_view, name='delete_developer'),
    path('developers/all/', get_all_developers_view, name='get_all_developers'),
    path('developers/<int:dev_id>/', get_developer_by_id_view, name='get_developer_by_id'),
    path('developers/<int:dev_id>/regenerate-token/', regenerate_api_token_view, name='regenerate_api_token'),
    path('developers/<int:dev_id>/validate-token/', validate_api_token_view, name='validate_api_token'),
]